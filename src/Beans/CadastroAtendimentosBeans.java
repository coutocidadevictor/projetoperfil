...
public class CadastroAtendimentosBeans {
    ...
    public CadastroAtendimentosBeans() {
    }

    public CadastroAtendimentosBeans(int IdAtendimentos, int idClientes, int idServico, int idColaboradores, String dataAtendimentos) {
