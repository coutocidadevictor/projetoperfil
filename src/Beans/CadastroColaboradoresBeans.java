...
public class CadastroColaboradoresBeans {
    ...
    public CadastroColaboradoresBeans(int IdColaboradores, String nomeColaboradores, String valor) {
        this.IdColaboradores = IdColaboradores;
        this.nomeColaboradores = nomeColaboradores;
        this.telefoneColaboradores = telefoneColaboradores;
    }

    public CadastroColaboradoresBeans() {
    }
