...
import static View.Colaboradores.tabelaPrincipalColaboradores;
...
public class Clientes extends javax.swing.JInternalFrame {
    ...
    public Clientes() throws SQLException {
        ...
        initComponents();
        Tabela modelo = CadastroClientesDAO.obterTabela();
    ...
    private void jbDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbDeletarActionPerformed
        CadastroClientesDAO tipoPagamento = new CadastroClientesDAO();
        //esse objeto pega os métodos gets e sets
        CadastroClientesBeans excluir = new CadastroClientesBeans();
        ...
        try {
            CadastroClientesDAO.listaClientes();
        } catch (SQLException ex) {
            Logger.getLogger(Clientes.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jbSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalvarActionPerformed
        ...
        CadastroClientesDAO cadClientes = new CadastroClientesDAO();
        //esse objeto pega os métodos gets e sets
        CadastroClientesBeans cadastro = new CadastroClientesBeans();
    ...
    private void tabelaPrincipalClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaPrincipalClientesMouseClicked
        CadastroClientesDAO buscaPressionando = new CadastroClientesDAO();
