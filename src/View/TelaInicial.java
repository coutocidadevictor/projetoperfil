...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void jMenuItemClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemClientesActionPerformed
                       Clientes chamar2 = null;
        try {
            chamar2 = new Clientes();
    ...
    private void jMenuItemColaboradoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemColaboradoresActionPerformed
                Colaboradores chamar1 = null;
        try {
            chamar1 = new Colaboradores();
        } catch (SQLException ex) {
            Logger.getLogger(TelaInicial.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jMenuItemRelatoriosServicosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemRelatoriosServicosActionPerformed
                               relatorioAtendimentos chamar1 = null;
        try {
            chamar1 = new relatorioAtendimentos();
        } catch (SQLException ex) {
            Logger.getLogger(TelaInicial.class.getName()).log(Level.SEVERE, null, ex);
        }
        jDesktopPane1.add(chamar1);
    ...
    try {
        Atendimentos chamar3 = new Atendimentos();
